...
export const getAllTimes = createAsyncThunk('dashboardhome/getTime', async (_, { dispatch }) => {
  try {
...
export const addCurrentTime = createAsyncThunk('dashboardhome/addTime', async (currentTime, { dispatch }) => {
  try {
