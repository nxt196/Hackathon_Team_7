...
export const getAllTimes = createAsyncThunk('pageOne/getTime', async (_, { dispatch }) => {
  try {
...
export const removeLastTime = createAsyncThunk('pageOne/removeLastTime', async (_, { dispatch }) => {
  try {
